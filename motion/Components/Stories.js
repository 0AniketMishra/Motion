  ...
  return (
     <View style={{ backgroundColor: 'black',}}>
         <View style={{ marginBottom: 12,marginTop: 10, marginLeft: 5,  }}>
          ...
          <TouchableOpacity>
          <View style={{marginLeft: 4, marginRight: 4,  width: 54, height: 54, backgroundColor: '#0078E9', borderRadius: 50, alignItems: "center", justifyContent: "center", alignItems: 'center' }}>
           <Ionicons name="add" size={30} color="#D4E4F4" style={{marginLeft:2}}/>
            </View>
          </TouchableOpacity>
